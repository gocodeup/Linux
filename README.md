...
2. Clone the environment repo to it with `git clone https://github.com/gocodeup/<project_example.git>`
3. Change to the approriate `Environment` directory created in your `~/bin` directory. These environments have been organized by Operating system or project. You would simply change into the directory for the OS you want to build. Example: ```cd ~/bin/SystemsEngineer/CentOS```
...
2. Use your browser of choice and navigate to https://github.com/gocodeup/SystemsEngineer or download” button then the “Download ZIP” button. Or use Github Desktop (See below).
